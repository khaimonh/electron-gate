  ...
  return (
    <div className="min-h-screen bg-[var(--color-paper)] text-[var(--color-ink)] flex flex-col selection:bg-[var(--color-atelier-brass)] selection:text-[var(--color-paper)]">
      ...
      <header className="sticky top-0 z-40 bg-[var(--color-paper)]/90 backdrop-blur-md border-b border-[var(--color-rule)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/cart"
              className="relative p-2 rounded border border-[var(--color-rule)] bg-[var(--color-paper-sub)] hover:border-[var(--color-atelier-brass)] transition-colors flex items-center gap-1.5"
              aria-label="View Cart"
            >
              <ShoppingCart className="w-4 h-4 text-[var(--color-ink-muted)]" />
              <span className="font-mono text-xs hidden sm:inline">Cart</span>
              {totalCartCount > 0 && (
                <span className="bg-[var(--color-atelier-brass)] text-[var(--color-paper)] font-mono text-[10px] font-bold px-1.5 py-0.2 rounded-full min-w-[18px] text-center">
                  {totalCartCount}
                </span>
              )}
            </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 w-full flex-1 flex flex-col">
        ...
        <div className="flex items-center gap-2 mb-6 font-mono text-xs text-[var(--color-ink-dim)]">
          <Link
            href="/products"
          ...
          <span className="text-[var(--color-ink)] font-semibold truncate max-w-[200px] sm:max-w-md">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <label className="font-mono text-xs text-[var(--color-ink)] font-semibold uppercase tracking-wider">
                          Hardware Configurations ({product.variants.length})
                        </label>
                        <span className="font-mono text-[10px] text-[var(--color-ink-dim)]">
                          Section 2.2 Active Variants
                        </span>
                      </div>
