    ...
    <div className="atelier-dashboard">
      ...
      <header className="atelier-dash-nav">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[var(--color-ink-muted)] font-mono text-xs hidden sm:inline">Ingestion Workspace</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="atelier-user-badge">
            ...
            <div className="flex items-center gap-2">
              <span className="font-mono text-xs text-[var(--color-ink)] max-w-[120px] truncate">
